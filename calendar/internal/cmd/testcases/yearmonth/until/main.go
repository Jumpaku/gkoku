...
import (
	"fmt"
	"github.com/Jumpaku/tokiope/calendar/internal/cmd/testcases/date"
	"github.com/Jumpaku/tokiope/calendar/internal/cmd/testcases/yearmonth"
...
func main() {
	...
	for _, sut := range yms {
		...
		for _, p := range periods {
			...
			fmt.Fprintf(out, "%d %d %d %d\n", sut.Year(), sut.Month(), in.Year(), in.Month())
		}
	}
	log.Println("YearMonth until testcases successfully generated in " + outputPath)
}
