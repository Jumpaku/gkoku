...
func TestYearWeekIterator_Date(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			want: OfDate(calendar.DateOfYMD(2024, calendar.MonthMarch, 6)),
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestYearWeekIterator_FirstDate(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name: "2024-W10",
			sut:  OfYearWeek(calendar.YearWeekOf(2024, 10)),
			want: OfDate(calendar.DateOfYWD(2024, 10, calendar.DayOfWeekMonday)),
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestYearWeekIterator_LastDate(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name: "2024-W10",
			sut:  OfYearWeek(calendar.YearWeekOf(2024, 10)),
			want: OfDate(calendar.DateOfYWD(2024, 10, calendar.DayOfWeekSunday)),
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
