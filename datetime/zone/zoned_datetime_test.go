...
func TestZonedDateTime_InstantCandidates(t *testing.T) {
	...
	instantOf := func(s string) gkoku.Instant {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: []gkoku.Instant{instantOf(`2024-03-13T00:00:00Z`)},
		},
		{
			sut:  NewZonedDateTime(dateOf(`2011-09-01`), timeOf(`12:00:00`), getZone(`Pacific/Apia`)),
			want: []gkoku.Instant{instantOf(`2011-09-01T12:00:00-11:00`)},
		},
		{
			sut:  NewZonedDateTime(dateOf(`2011-12-29`), timeOf(`12:00:00`), getZone(`Pacific/Apia`)),
			want: []gkoku.Instant{instantOf(`2011-12-29T12:00:00-10:00`)},
		},
		{
		...
		},
		{
			...
			want: []gkoku.Instant{instantOf(`2011-12-31T12:00:00+14:00`)},
		},
		{
			sut:  NewZonedDateTime(dateOf(`2012-09-01`), timeOf(`12:00:00`), getZone(`Pacific/Apia`)),
			want: []gkoku.Instant{instantOf(`2012-09-01T12:00:00+13:00`)},
		},
		{
			sut:  NewZonedDateTime(dateOf(`2023-01-01`), timeOf(`12:00:00`), getZone(`Europe/Zurich`)),
			want: []gkoku.Instant{instantOf(`2023-01-01T12:00:00+01:00`)},
		},
		{
